    ...
    <div class="container px-12 pb-36 pt-12 lg:mt-8 max-lg:px-10 max-sm:px-5 mx-auto min-h-screen">
        ...
        <section class="user-created card card-compact bg-white shadow-xl rounded-md">
            <div class="card-body">
                ...
                <form action="{{ route('users.store') }}" method="POST" class="grid gap-3" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="grid grid-cols-2 gap-5">
                        ...
                        <div class="form-control">
                            ...
                            <select id="countries" name="roles"
                                ...
                                <option value="ADMIN KORAMIL">ADMIN KORAMIL</option>
                                <option value="KEPALA KORAMIL">KEPALA KORAMIL</option>
