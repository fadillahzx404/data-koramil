    ...
    <div class="container px-12 pb-36 pt-12 lg:mt-8 max-lg:px-10 max-sm:px-5 mx-auto min-h-screen">
        ...
        <section class="user-created card card-compact bg-white shadow-xl rounded-md">
            <div class="card-body">
                ...
                <form action="{{ route('users.update', $data->id) }}" method="POST" class="grid gap-3"
                    ...
                    <div class="mb-6">
                        ...
                        <div class="grid grid-cols-2 max-sm:grid-cols-1 gap-5">
                            <div class="flex flex-col">
                                ...
                                <p class=" text-xs text-center text-gray-400 dark:text-red-600">If you doesn't wanna use a
                    ...
                    <div class="grid grid-cols-2 gap-5">
                        ...
                        <div class="form-control">
                            ...
                            <div class="relative">
                                <input type="password" name="password" id="pass-input" value="{{ $data->password }}"
                                    class="input input-bordered input-neutral w-full focus:outline-offset-0 focus:border-neutral" />
                    ...
                    <div class="grid grid-cols-2 gap-5">
                        ...
                        <div class="form-control">
                            ...
                            <select id="countries" name="roles"
                                ...
                                <option value="MASTER ADMIN" @if ($data->roles == 'MASTER ADMIN') selected @endif>MASTER ADMIN
                                </option>
                                <option value="ADMIN KORAMIL" @if ($data->roles == 'ADMIN KORAMIL') selected @endif>ADMIN
                                    KORAMIL</option>
                                <option value="KEPALA KORAMIL" @if ($data->roles == 'KEPALA KORAMIL') selected @endif>KEPALA
                                    KORAMIL</option>
                                <option value="KODIM" @if ($data->roles == 'KODIM') selected @endif>KODIM</option>
