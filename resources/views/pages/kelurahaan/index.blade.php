            ...
            <div class="title-table grid">
                <div class="flex justify-between">
                    <div class="grid place-content-center">
                        <p class="text-lg font-bold">Kelurahaan</p>
                        <p class="text-sm font-light text-gray-400">Kelurahaan on here, you can add new user, edit or
                            delete.
                        </p>
                    </div>
                    <a href="{{ route('kelurahaan.create') }}"
