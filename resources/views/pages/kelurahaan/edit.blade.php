        ...
        <section class="user-created card card-compact bg-white shadow-xl rounded-md">
            <div class="card-body">
                <div class="grid title gap-2">
                    <p class="text-lg font-medium">Tambah Kelurahaan</p>
                    <hr class="mb-3 border-gray-300" />
                </div>
                <form action="{{ route('kelurahaan.update', $kel->id) }}" method="POST" class="grid gap-3"
                    ...
                    <div class="form-control">
                        <label class="label">
                            <span class="label-text">Nama Kelurahaan</span>
                        </label>
                        <input type="text" name="nama_kelurahaan" value="{{ $kel->nama_kelurahaan }}"
