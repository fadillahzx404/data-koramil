...
@section('page-content')
    <div class="error-data" data-error="{!! \Session::get('error') !!}"></div>
    <div class="container px-12 lg:mt-8 max-lg:px-10 max-sm:px-5 mx-auto min-h-screen">
        <section class="user-created card card-compact bg-white shadow-xl rounded-md">
            <div class="card-body">
                ...
                <form action="{{ route('datas.update', $datas->id) }}" method="POST" class="grid gap-3"
                    ...
                    <div class="flex justify-around  items-center mb-3">
                        ...
                        <div class="month">
                            ...
                            <div class="join join-horizontal">
                                <input class="join-item btn w-full " type="radio" name="month"
                                    ...
                                    {{ $datas->month == 'Janurari-Juni' ? 'checked' : '' }} disabled />
                                <input class="join-item btn w-full" type="radio" name="month"
                                    aria-label="Juli - Desember" value="Juli-Desember"
                                    {{ $datas->month == 'Juli-Desember' ? 'checked' : '' }} disabled />
                        ...
                        <div class="year">
                            ...
                            <div class="relative max-w-sm">
                                ...
                                <input id="datepickerId" type="text" name="year" value="{{ $datas->year }}"
                    ...
                    <div class="kelurahaan">
                        <label class="form-control w-full ">
                            ...
                            <select class="select select-bordered" name="kelurahaan_id" disabled>
                                @foreach ($kelurahaan as $kel)
                                    <option value="{{ $kel->id }}"
                                        {{ $kel->id == $datas->kelurahaan_id ? 'selected' : '' }}>
                                        {{ $kel->nama_kelurahaan }}
                                        {{ $datas->nama_kelurahaan }}</option>
                                @endforeach
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            ...
                            <label class="form-control w-full ">
                                ...
                                <input type="number" class="input input-bordered w-full"
                                    value="{{ $datas->penduduk[0]->jumlah_penduduk_laki_laki }}"
                                    name="penduduk_laki_laki"required />
                            </label>
                            ...
                            <label class="form-control w-full ">
                                ...
                                <input type="number" class="input input-bordered w-full " name="penduduk_perempuan"
                                    value="{{ $datas->penduduk[0]->jumlah_penduduk_perempuan }}" required />
                            </label>
                    ...
                    <div class="jumlah-wajib-ktp mt-3">
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            ...
                            <label class="form-control w-full">
                                ...
                                <input type="number" class="input input-bordered w-full"
                                    value="{{ $datas->wajib_ktp[0]->wajib_ktp_laki_laki }}"
                            ...
                            <label class="form-control w-full">
                                ...
                                <input type="number" class="input input-bordered w-full" name="wajib_ktp_perempuan"
                                    value="{{ $datas->wajib_ktp[0]->wajib_ktp_perempuan }}" required />
                            </label>
                    ...
                    <div class="jumlah-kk mt-3">
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            ...
                            <label class="form-control w-full">
                                ...
                                <input type="number" class="input input-bordered w-full" name="kk_laki_laki"
                                    value="{{ $datas->kartu_keluarga[0]->kk_laki_laki }}" required />
                            </label>
                            ...
                            <label class="form-control w-full">
                                ...
                                <input type="number" class="input input-bordered w-full" name="kk_perempuan"
                                    value="{{ $datas->kartu_keluarga[0]->kk_perempuan }}" required />
                            </label>
                    ...
                    <div class="status-perkawinan mt-3 mb-8">
                        ...
                        @foreach ($datas->status_perkawinan as $skw)
                            <div class="grid grid-cols-3 gap-4">
                                ...
                                <label class="form-control w-full ">
                                    ...
                                    <input type="text" class="input input-bordered w-full" name="status_perkawinan[]"
                                        value="{{ $skw->status_perkawinan }}" readonly />
                                ...
                                <label class="form-control w-full">
                                    ...
                                    <input type="number" class="input input-bordered w-full"
                                        name="jumlah_status_laki_laki[]" value="{{ $skw->jumlah_status_laki_laki }}"
                                        required />
                                </label>
                                ...
                                <label class="form-control w-full">
                                    ...
                                    <input type="number" class="input input-bordered w-full"
                                        name="jumlah_status_perempuan[]" value="{{ $skw->jumlah_status_perempuan }}"
                                        required />
                                </label>
                        ...
                        @foreach ($datas->agama as $agm)
                            <div class="grid grid-cols-3 gap-4">
                                ...
                                <label class="form-control w-full">
                                    ...
                                    <input type="number" class="input input-bordered w-full"
                                        name="jumlah_agama_laki_laki[]" value="{{ $agm->jumlah_agama_laki_laki }}"
                                        required />
                                </label>
                                ...
                                <label class="form-control w-full">
                                    ...
                                    <input type="number" class="input input-bordered w-full"
                                        name="jumlah_agama_perempuan[]" value="{{ $agm->jumlah_agama_perempuan }}"
                                        required />
                                </label>
                    ...
                    <label class="form-control
                        ...
                        <textarea class="textarea textarea-bordered h-24" placeholder="Keterangan" name="keterangan">{{ $datas->keterangan }}</textarea>
